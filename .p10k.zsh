# Generated by Powerlevel10k configuration wizard on 2019-11-11 at 09:42 GMT.
...
# disconnected, no frame, compact, few icons, concise.
...
() {
  ...
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}/${P9K_KUBECONTEXT_NAMESPACE}}'
